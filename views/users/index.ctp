<div class="users index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('blog_count');?></th>
	...
	<tr<?php echo $class;?>>
		...
		<td><?php echo $user['User']['blog_count']; ?>&nbsp;</td>
		<td><?php echo $user['User']['admin']; ?>&nbsp;</td>
		<td><?php echo $user['User']['created']; ?>&nbsp;</td>
		<td><?php echo $user['User']['modified']; ?>&nbsp;</td>
		<td><?php echo $user['User']['profile']; ?>&nbsp;</td>
		<td><?php echo $user['User']['url']; ?>&nbsp;</td>
		<td><?php echo $user['User']['confirmation']; ?>&nbsp;</td>
		<td><?php echo $user['User']['question']; ?>&nbsp;</td>
		<td><?php echo $user['User']['answer']; ?>&nbsp;</td>
		<td class="actions">
