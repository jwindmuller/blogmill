    ...
    return this.each(function(i, widget){
      ...
      $.getJSON(build_url(), function(data){
        ...
        $.each(tweets, function(i,item){
          ...
          var date = '<span class="tweet_time">' + relative_time(item.created_at) + '<a href="http://twitter.com/'+from_user+'/statuses/'+item.id+'" title="view tweet on twitter">@' + from_user + '</a></span>';
